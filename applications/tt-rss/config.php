<?php
	...
	define('SELF_URL_PATH', 'https://rss.zfix.org/');
	...
	// Please see  below to configure various authentication modules.
	...
	define('SMTP_FROM_ADDRESS', 'noreply@zfix.org');
	...
	define('PLUGINS', 'auth_ldap, note, api_feedreader');
	...
	// ************
	// Required parameters:
	define('LDAP_AUTH_SERVER_URI', 'ldap://ldap:389/');
	define('LDAP_AUTH_USETLS', FALSE); // Enable StartTLS Support for ldap://
	define('LDAP_AUTH_ALLOW_UNTRUSTED_CERT', TRUE); // Allows untrusted certificate
	define('LDAP_AUTH_BASEDN', 'ou=users,dc=zfix,dc=org');

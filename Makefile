...
base-uwsgi:
	docker buildx build $(DOCKER_ARGS) --tag mrksr/uwsgi base/uwsgi
	docker buildx build $(DOCKER_ARGS) --tag mrksr/uwsgi-python2 --file base/uwsgi/Dockerfile.python2 base/uwsgi
